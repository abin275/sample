			 ...
			 <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            DOOR STEP BIKE SERVICE BOOKING <small></small>
                        </h1>
                    </div>
                </div> 
            ...
            <?php
                ...
                <div class="col-md-9 col-sm-9">
                    <div class="panel panel-primary">
						...
						<form id='userreg' action="doorstep.php" name="form" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                              ...
                              <label for="location">LOCATION:</label>
                                <input  type= "text" id="location" class="form-control" name="location" placeholder="ENTER LOCATION" octavalidate="R,ALPHA_SPACES" > 
