			 ...
			 <div class="row">
                 ...
                 <div class="row">
							  ...
							  <div class="form-group">
                                            ...
                                            <input id="a" name="fname" class="form-control" required>
                    ...
                    <div class="well">
                        <form action="aaa.php">
						<input type="submit" id="b" name="submit" class="btn btn-primary">
