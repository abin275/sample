        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="row">
                ...
                <div class="card">
                  <div class="card-body">
                    <form action="prevact.php" method="post" class="form-sample" id="registration_form" >
					 ...
					 <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                               <select name="year" placeholder="date"  class="form-control">
							   <?php $op="SELECT DISTINCT year FROM tbl_year";
$resop= $conn->query($op);
if ($resop->num_rows > 0) {
  // output data of each row
  while($rowp = $resop->fetch_assoc()) {?>         
<option value="<?php echo $rowp['year']?>"><?php echo $rowp['year'] ?></option>
<?php }}?>
                              </select>
                            </div>
                          </div>
...
<?php $op="SELECT DISTINCT types from tbl_report_type";
$resop= $conn->query($op);
if ($resop->num_rows > 0) {
  // output data of each row
  while($rowp = $resop->fetch_assoc()) {?>  							   
                                <option value="<?php echo $rowp['types']?>"><?php echo $rowp['types']?></option>
<?php }}?>
                              </select>
                            </div>
                          </div>
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          ...
                          <button type="reset"  class="btn btn-light" type="reset">Clear</button>
                        </div>
