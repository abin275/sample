        ...
        <ul class="nav">
          ...
          <!-- <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="in.php">Add Products</a></li>
                <li class="nav-item"> <a class="nav-link" href="manageproduct.php">Manage Products</a></li>
              </ul>
            </div> -->
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="form-elements">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"><a class="nav-link" href="profileinformation.php">profile</a></li>
                <li class="nav-item"><a class="nav-link" href="address.php">Add address</a></li>
          ...
          <!-- <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#form-elements" aria-expanded="false" aria-controls="form-elements">
              <i class="typcn typcn-user-outline menu-icon"></i>
              <span class="menu-title">Data Visualization</span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="form-elements">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"><a class="nav-link" href="dataanalysis.php">Sales analysis</a></li>
                <li class="nav-item"><a class="nav-link" href="fav.php">Favourite product analysis</a></li>
              </ul>
            </div>
          </li> -->
          <li class="nav-item">
