...
$sql=mysqli_query($con,"insert into product(category_id,product_name,price,Total_quantity,product_desc,product_image) values('$category','$productname','$productprice','$quantity','$productdescription','$image')");
        ...
        <ul class="navbar-nav mr-lg-2">
          <li class="nav-item nav-profile dropdown">
            <a class="nav-link" href="#" data-toggle="dropdown" id="profileDropdown">
              ...
              <span class="nav-profile-name">Ann</span>
            </a>
    ...
    <div class="container-fluid page-body-wrapper">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="insert.php">Add Products</a></li>
      ...
      <div class="content">
        <div class="container-fluid">
          ...
          <form class="form-horizontal row-fluid" name="insertproduct" method="post" enctype="multipart/form-data" style="background-color:	 #2eb8b8">
      ...
      <input type="text" name="productDescription" placeholder="Enter Product Description" rows="6" style="height:100px" class="span8 tip" minlength="20"
      ...
      $('#file').on('change',function(){
        ...
        if(upld=='jpg'){
          alert("File uploaded is successfull")
        }else{
