...
<script type="text/javascript">
 ...
 ['orders','Number'],
 <?php 
      $query = "SELECT count(order_items.product_id) AS number, product.product_name FROM product INNER JOIN order_items WHERE product.product_id=order_items.product_id GROUP BY order_items.product_id";
