...
<script type="text/javascript">
 ...
 ['tblcart','Number'],
 <?php 
      $query = "SELECT count(tblcart.accessories_id) AS number, tbl_accessories.name FROM tbl_accessories INNER JOIN tblcart WHERE tbl_accessories.accessories_id=tblcart.accessories_id GROUP BY tblcart.accessories_id";
