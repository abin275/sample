...
if(isset($_POST['submit'])){
   ...
   move_uploaded_file ($temp, $finalImage);
    ...
    $product_price=='' or $product_quantity=='' or $product_address=='' or $product_color=='' or $finalImage=='' ){
...
//
$product_category=="SELECT 'category_id' FROM `tbl_category`";
 $insert_products="INSERT INTO tbl_accessories(`category_id`, `name`, `quantity`, `description`, `price`, `specification`, `company`, `second_id`, `color`, `image`) 
VALUES ('$product_category',' $product_title','$product_quantity','$description','$product_price','$product_specification','$product_address' , '$product_category2' , '$product_color' , '$finalImage')";
