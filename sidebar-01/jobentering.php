...
<div class='dashboard'>
  ...
  background-size: cover;">
            <div class='container'>
            <h2 class="text-center font-monospace fw-bolder">POST JOBS</h> 
                        <div class='card mt-1 bg-'>
                            <div class='card-header'>
                              <h4 class="text-start font-monospace fw-bold">INSERT JOB DETAILS</h4>
                              <div class='card-body'>
                                <form method="post" action="jobentering.php" enctype="multipart/form-data">
                                <div class="row">

                                        <div class="col-lg-12 col-md-12">
                                            <div class="form-group text-start">
                                            <label for="title" class="form-label fw-normal fs-5">JOB NAME</label>
                                        ...
                                        <div class="col-lg-12 col-md-12 mt-2">
                                            <div class="form-group text-start">
                                                <label class="form-label fw-normal fs-5">SALARY</label>
                                                <input type="text" class="form-control" name="salary" placeholder="Location">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-12 col-md-12 mt-2">
                                            <div class="form-group text-start">
                                                <label class="form-label fw-normal fs-5">JOB TYPE</label>
                                                <input type="text" class="form-control" name="jobtype" placeholder="full time or part time">
                                            </div>
                                        </div>
